...
BASE_COMPOSE_FILE_URL="https://raw.githubusercontent.com/DefGuard/deployment/one_line_install/docker-compose/docker-compose.yaml"
BASE_ENV_FILE_URL="https://raw.githubusercontent.com/DefGuard/deployment/one_line_install/docker-compose/.env.template"
